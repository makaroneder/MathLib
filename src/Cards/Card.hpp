...
struct Card : MathLib::Printable {
    ...
    Card(MathLib::DummyRenderer* image = nullptr);
    ...
    template <typename T>
    [[nodiscard]] bool Draw(MathLib::Renderer& renderer, const MathLib::Matrix<T>& position, const MathLib::Matrix<T>& rotation) const {
