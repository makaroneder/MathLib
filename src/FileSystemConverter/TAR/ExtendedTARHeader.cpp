...
bool ExtendedTARHeader::Create(const MathLib::Sequence<char>& path_, size_t dataSize, const char* expectedSignature, const char* expectedVersion) {
    ...
    const MathLib::String name = "MathLib";
