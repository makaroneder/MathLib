#ifndef MathLib_Cryptography_Cipher_AES_H
...
namespace MathLib {
    struct AES : Cipher {
        ...
        static void ShiftRows(Matrix<ByteFiniteField>& state);
        static void InverseShiftRows(Matrix<ByteFiniteField>& state);
        ...
        static constexpr uint8_t rsbox[] = {
