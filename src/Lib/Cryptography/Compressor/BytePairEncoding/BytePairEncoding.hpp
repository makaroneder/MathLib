...
namespace MathLib {
    struct BytePairEncoding : ReadableCipher {
        ...
        [[nodiscard]] virtual Array<uint8_t> DecryptReadablePartial(Readable& readable, const Sequence<uint64_t>& key, const MathLib::Interval<size_t>& range) const override;
