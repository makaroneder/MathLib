#ifndef MathLib_FileSystem_MemoryFS_H
#define MathLib_FileSystem_MemoryFS_H
#include "MemoryFSFile.hpp"
#include "../FileSystem.hpp"
#include "MemoryFSResource.hpp"

namespace MathLib {
    struct MemoryFS : FileSystem {
        MemoryFS(void);
        /// @brief Opens file
        ...
        private:
        Array<MemoryFSResource> resources;
        Array<MemoryFSFile> files;
    };
}
