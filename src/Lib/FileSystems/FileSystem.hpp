...
struct FileSystem : Allocatable {
    ...
    virtual size_t Read(const size_t& file, void* buffer, const size_t& size, const size_t& position) = 0;
    ...
    virtual size_t Write(const size_t& file, const void* buffer, const size_t& size, const size_t& position) = 0;
