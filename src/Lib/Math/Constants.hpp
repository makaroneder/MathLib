...
namespace MathLib {
    ...
    static const num_t magicAngle = 0.95532;
    static const num_t silverRatio = 1 + Sqrt(2);
    static const num_t goldenRatio = (1 + Sqrt(5)) / 2;
    static const num_t superGoldenRatio = (1 + Cbrt((29 + 3 * Sqrt(93)) / 2) + Cbrt((29 - 3 * Sqrt(93)) / 2)) / 3;
    static const num_t plasticRatio = Cbrt(1 / 2 + Sqrt(69) / 18) + Cbrt(1 / 2 - Sqrt(69) / 18);
    static const num_t connectiveConstant = Sqrt(2 + Sqrt(2));
    static const num_t keplerBouwkampConstant = 0.11494204485329620070;
    static const num_t wallisConstant = Cbrt((45 - Sqrt(1929)) / 18) + Cbrt((45 + Sqrt(1929)) / 18);
    ...
    static const num_t ramanujanConstant = Exp(pi * Sqrt(163));
    ...
    static const num_t secondDuBoisReymondConstant = (Exp(2) - 7) / 2;
