...
static const WattPerSquareMetreKelvinToTheFourth<num_t> stefanBoltzmannConstant = (boltzmannConstant.Pow(4) * std::pow(pi, 2)) / (reducedPlanckConstant.Pow(3) * speedOfLightInVacuum.Pow(2) * 60);
