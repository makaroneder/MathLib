...
Date Date::FromTimestampMacro(const char* timeStamp) {
    ...
    const MathLib::Array<MathLib::String> split2 = MathLib::Split(split1.At(4), ":"_M, false);
    uint8_t month = 0;
    ...
    return Date(MathLib::StringToNumber(split2.At(2)), MathLib::StringToNumber(split2.At(1)), MathLib::StringToNumber(split2.At(0)), MathLib::StringToNumber(split1.At(2)), month, MathLib::StringToNumber(split1.At(5)));
}
